    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto flex">
        ...
        <main className="flex-1 p-4 md:p-8">
          <h2 className="text-3xl font-bold mb-2 text-blue-900">Dashboard</h2>
          <p className="mb-8 text-lg text-slate-700">Welcome, <span className="font-semibold text-blue-700">{user?.name}</span></p>
